...
export default {
    ...
    mounted(){
       this.$can('/tiposdocs', 'No tiene permisos para ver esta pantalla')
    },
    created(){
        this.initialize()
    },
    ...
    computed:{
      ...
      dlgTitle () {
        return this.delItem === 1 ? '¿Esta seguro de dar de baja este tipo?' : '¿Esta seguro de dar de alta este tipo?'
      },
      dlgSubTitle () {
        return this.delItem === 1 ? 'Al dar de baja el tipo las relaciones con los documentos seguirán registradas, pero no podrá ser asignado a nuevos documentos.' : 'Al dar de alta este tipo podrá ser asignado a nuevos documentos'
      },
    },
    methods:{
      initialize () {
